...
const Dashboard = () => {
  ...
  const generateNormativeData = (region) => {
    ...
    // Use actual volume from results if available, otherwise use realistic base
    const actualVolume = results.normative.volumetric_features?.[region];
    const baseVolume = actualVolume || getRealisticBaseVolume(region);
            ...
            <div className="right-column">
              ...
              <div className="clinical-interpretation">
                ...
                <div className="interpretation-content">
                  <p>
                    The subject's brain volume is at the <strong>{getPercentilePosition()?.percentile || 'N/A'}th percentile</strong> for 
